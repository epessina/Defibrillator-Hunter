...
const defibrillator = {
    ...
    /** Displays all the defibrillators of the currently logged user on the map */
    showAll: () => {
        ...
        return new Promise((resolve, reject) => {
            ...
            fetch(
                ...
                .then(res => {
                    ...
                    // Delete from the markers array the one correspondent to the delete defibrillator
                    defibrillator.markers = defibrillator.markers.filter(m => m._id !== id);
